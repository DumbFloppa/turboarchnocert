...
if [ -d '/archlinux-bootstrap' ]; then
  ...
  if command -v curl &> /dev/null; then
    curl -L -o archlinux-bootstrap.tar.zst http://mirrors.edge.kernel.org/archlinux/iso/latest/archlinux-bootstrap-x86_64.tar.zst
  else
    wget -O archlinux-bootstrap.tar.zst http://mirrors.edge.kernel.org/archlinux/iso/latest/archlinux-bootstrap-x86_64.tar.zst
  fi
